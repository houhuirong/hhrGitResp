...
public class EmployeeQueryByDeptUserVo {
	...
	private String probationEndTime;	//试用期结束日期
	...
	/**
	 * @param dimissionTime the dimissionTime to set
	 */
	...
	/**
	 * @param probationEndTime the probationEndTime to set
	 */
	...
	public String toString() {
		return "EmployeeQueryByDeptUserVo [name=" + name + ", employeeId=" + employeeId + ", sex=" + sex
				...
				+ ", rank=" + rank + ", positionName=" + positionName + ", count=" + count + ", dimissionTime="
				+ dimissionTime + ", probationEndTime=" + probationEndTime + ", idCardNumber=" + idCardNumber
				+ ", status=" + status + "]";
	}
