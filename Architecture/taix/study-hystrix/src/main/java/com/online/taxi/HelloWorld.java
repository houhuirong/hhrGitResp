...
public class HelloWorld extends HystrixCommand {
...
//		String result = (String)new HelloWorldHysteriaCommand("msb").execute();
...
/**
		...
		Future<String> futureResult = new HelloWorld("msb").queue();
		String result = "";
		try {
