...
public class OperatorDemo{
    ...
    public static void main(String[] args){
        ...
        c = c + 2;
        c += 2;
        //类型转换问题，d是byte，d+1整体变成int类型，需要将int类型的值转换位byte，会有精度损失，因此需要强制转换
        //建议在进行操作的时候使用扩赋值运算符
        byte d = 10;
        //d = d+1;
        d+=1;
		...
		/*
			...
			&:与运算符，但是两边都会参与运算，两边是表达式
			|:或运算符，两边都会参与运算，两边是表达式
		*/
