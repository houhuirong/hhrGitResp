...
/**
 * @Auther: hhr
 * @Date: 2020/9/2 - 09 - 02 - 15:10
 * @Description: com.mashibing
 * @version: 1.0
 */
public class TestGenator {
    @Test
    public void testGenator(){
        AutoGenerator autoGenerator = new AutoGenerator();

        //全局配置
        GlobalConfig globalConfig = new GlobalConfig();
        globalConfig.setAuthor("hhr")
                .setOutputDir("E:\\hhrGitResp\\javase\\project\\famliy_service_platform\\src\\main\\java")//设置输出路径
